...
import com.cloud.upgrade.dao.Upgrade42220to42230;
import com.cloud.upgrade.dao.Upgrade42230to42300;
    ...
    public DatabaseUpgradeChecker() {
        ...
        hierarchy = DatabaseVersionHierarchy.builder()
                ...
                .next("4.21.0.0", new Upgrade42100to42200())
                 ...
                 .next("4.22.2.0", new Upgrade42220to42230())
                 .next("4.22.3.0", new Upgrade42230to42300())
                 .build();
    }
